...
mod windows_bridge {
    ...
    // CastleDB unit.flags Elite / Boss / Miniboss / Unique (from
    // assets/unit_traits.json via tools/extract_unit_traits.py).
    const ELITE_KINDS: &[&str] = &[
        "Bee_Z1W_E",
        "Boar_Z1W_E",
        "Boar_Z2W_E",
        "Boar_Z4W_E",
        ...
        "Crimson_Z2W_Captain_E",
        "Crimson_Z2W_Captain_E_2",
        "Crimson_Z2W_Peasant_E",
        "Crimson_Z3W_Caster_E",
        "Crimson_Z3W_Daggers_E",
        "Crimson_Z3W_GA_E",
        "Crimson_Z3W_Sword_E",
        "Demon_Z3W_Claws_E",
        "Demon_Z3W_Claws_E_1",
        "Dog_Z3W_E",
        "FaerieBee_Z1W_Claws_E",
        "FaerieBee_Z1W_GreatMace_E",
        "FaerieBee_Z2W_GreatMace_E",
        "FaerieDemon_Z3W_Caster_E",
        "FaerieDemon_Z3W_Caster_E1",
        "Golem_Z1W_Earth_E",
        "Golem_Z1W_Earth_E_2",
        "Golem_Z2W_E",
        "Golem_Z2W_E_2",
        "Golem_Z2W_FireExplosive_E",
        "Golem_Z2W_FireExplosive_E_2",
        "ImpDemon_Elite_Red",
        "Manfish_Z1W_E_Spear",
        "Manfish_Z2W_E_Spear_2",
        "OgreHuman_Z2W_Peasant_E",
        "OgreHuman_Z3W_GM_E",
        "OgreKobold_Z1W_E_Claws",
        "OgreManfish_Z2W_Claws_E",
        "Slime_Demonic_Z3W_E",
        "Slime_Z1W_E",
        "Slime_Z1W_E_2",
        "Spirit_Z2W_Claws_E",
        ...
        "Spirit_Z3W_Claws_E",
        "Sprout_Rice_Z2W_E",
        "Sprout_Rice_Z2W_Plantivore",
        "Sprout_Rice_Z2W_Plantivore_2",
        "Sprout_Rice_Z2W_Plantivore_3",
        "Sprout_Rice_Z2W_Plantivore_4",
        "Sprout_Rice_Z2W_Plantivore_5",
        "Sprout_Rice_Z2W_Plantivore_6",
        "Wolf_Z1W_E",
    ];
    const BOSS_KINDS: &[&str] = &[
        "Cleodora",
        "Crabgantua",
        "DemonSuperElite",
        "DemonSuperElite_Fairy",
        "DemonSuperElite_Fairy_FalseClone",
        "DemonSuperElite_Fairy_TrueClone",
        "Gatsbee",
        "Golcano",
        "Mokshi",
        "MunsterChuck",
    ...
    const MINIBOSS_KINDS: &[&str] = &[
        "Cleodora_Champion",
        "Cleodora_Champion2",
        "Cleodora_Champion3",
        "Slime_Z1D_U",
    ];
    const UNIQUE_KINDS: &[&str] = &[
        "Bee_Z1W_U",
        "Bee_Z2W_U",
        "Boar_Z2W_U",
        "Crab_Z1W_U",
        "Crimson_Z1W_Captain_U",
        "Crimson_Z2W_Captain_U",
        "Crimson_Z2W_Captain_U_2",
        "Crimson_Z2W_Captain_U_3",
        "Crimson_Z2W_Captain_U_4",
        "Crimson_Z2W_Captain_U_5",
        "Crimson_Z2W_Captain_U_6",
        "Crimson_Z3D_Captain",
        "Crimson_Z3D_Captain1",
        "Crimson_Z3D_Captain2",
        "Crimson_Z3W_Captain_U",
        "Crimson_Z3W_Captain_U_1",
        "Crimson_Z3W_Captain_U_2",
        "Crimson_Z3W_GA_U",
        "Crimson_Z3W_Monk_U",
        "Crimson_Z3W_Monk_U1",
        "Crimson_Z3W_Monk_U2",
        "Crimson_Z3W_Peasant_U",
        "Crimson_Z3_Fist_U",
        "Crimson_Z3_Fist_U1",
        "Crimson_Z3_Fist_U2",
        ...
        "Elemental_Z1W_Earth_U",
        "Elemental_Z2W_Underwater_U",
        "Elemental_Z3W_Earth_U",
        "FaerieBee_Z1W_Spear_U",
        "FaerieBee_Z2W_Champ_E",
        "FaerieBee_Z2W_GreatMace_U",
        "FaerieBee_Z2W_GreatMace_U_2",
        "FaerieBee_Z2W_Spear_U",
        "FaerieDemon_Z1_Soulstone_Leg",
    ...
    fn read_nearby_enemies(
        ...
        for unit in read_array_pointers(process, storage, length as usize) {
            ...
            enemies.push(EnemySample {
                ...
                elite: kind_in_list(&kind, ELITE_KINDS),
                boss: kind_in_list(&kind, BOSS_KINDS),
                miniboss: kind_in_list(&kind, MINIBOSS_KINDS),
                unique: kind_in_list(&kind, UNIQUE_KINDS),
                kind,
                x: (x * 10.0).round() / 10.0,
                y: (y * 10.0).round() / 10.0,
                z: (z * 10.0).round() / 10.0,
