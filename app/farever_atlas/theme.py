...
QToolButton#codexModeButton:hover {
    color: #dce6ee;
    background: #202b36;
}
QToolButton#codexModeButton:checked {
    color: #eef3f7;
    background: #2a3946;
}
QComboBox#codexNavCombo {
    color: #dce6ee;
    background: #10171e;
...
QComboBox#codexNavCombo:hover {
    border-color: #587083;
    background: #141e27;
}
QComboBox#codexNavCombo::drop-down {
    border: none;
    width: 18px;
}
QLabel#codexSummaryLabel {
    color: #dce6ee;
    font-size: 10px;
    font-weight: 600;
    background: transparent;
...
QWidget#codexBrowsePanel,
QWidget#codexBrowseLeft,
QWidget#codexBrowseControls,
QWidget#codexTileGridHost,
QScrollArea#codexTileGridScroll {
    background: transparent;
    border: none;
}
...
QToolButton#codexFilterChip:hover {
    color: #e4ebf1;
    background: #22303b;
    border-color: #3d5061;
}
QToolButton#codexFilterChip:checked {
    color: #ffffff;
    background: #285f8b;
    border-color: #3979a9;
    font-weight: 600;
...
QLabel#codexDetailStatus[mastered="true"] {
    color: #eef3f7;
    background: #285f8b;
    border-color: #3979a9;
}
QLabel#codexDetailSection {
    color: #9aabba;
    font-size: 10px;
    font-weight: 700;
    letter-spacing: 0.4px;
...
QWidget#mainNavigationContent QGroupBox QLabel#settingsDeferredNote {
    color: #6f8192;
    font-size: 9px;
    font-weight: 400;
    padding: 0;
...
QWidget#mainNavigationContent QGroupBox QLabel#settingsRowTitle {
    color: #dce6ee;
    font-size: 11px;
    font-weight: 600;
}
QWidget#mainNavigationContent QGroupBox QLabel#settingsRowHint {
    color: #6f8192;
    font-size: 9px;
    font-weight: 400;
}
QWidget#mainNavigationContent QFrame#settingsRowSeparator {
    background: #24303a;
    border: none;
    max-height: 1px;
    margin: 0px;
...
QWidget#mainNavigationContent QLineEdit,
QWidget#mainNavigationContent QLineEdit#settingsField,
QWidget#mainNavigationContent QSpinBox {
    min-height: 28px;
    max-height: 28px;
    color: #dce6ee;
    background: #10171e;
...
QWidget#mainNavigationContent QCheckBox#settingsToggle,
QWidget#mainNavigationContent QCheckBox#settingsToggle:hover,
QWidget#mainNavigationContent QCheckBox#settingsToggle:checked,
QWidget#mainNavigationContent QCheckBox#settingsToggle:disabled {
    background: transparent;
    border: none;
    spacing: 0;
    min-width: 36px;
...
QWidget#mainNavigationContent QCheckBox#settingsToggle::indicator {
    width: 36px;
    height: 20px;
    border: none;
    background: transparent;
