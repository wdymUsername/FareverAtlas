...
UI_LOCK_RELATIVE_PATH = Path("ui/chrome/lock.svg")
UI_LOCK_HOVER_RELATIVE_PATH = Path("ui/chrome/lock_hover.svg")
UI_UNLOCK_RELATIVE_PATH = Path("ui/chrome/unlock.svg")
UI_UNLOCK_HOVER_RELATIVE_PATH = Path("ui/chrome/unlock_hover.svg")
