"""Frameless window title bar, controls, and resize grips."""
...
from .controls import SlideSwitch
from .map_widgets import WindowResizeGrip
from .navigation_overlay import MainNavigationOverlay


class MapWindowChromeMixin:
    """Frameless shell: title bar drag, window controls, and resize grips."""
    ...
    def _init_frameless_chrome(self) -> None:
        ...
        self.online_switch = SlideSwitch(self.app_title_bar)
        ...
        self.online_switch.sync_position()
    ...
    def _build_preview_menu(self) -> None:
        ...
        self.main_menu_icon_normal = QtGui.QIcon(
            str(PROJECT_ROOT / "assets" / "settings.svg")
        )
        self.main_menu_icon_hover = QtGui.QIcon(
            str(PROJECT_ROOT / "assets" / "settings_hover.svg")
        )
